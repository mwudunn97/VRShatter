...
public class MegaCacheFace
{
	...
	public MegaCacheFace(Vector3 _v0, Vector3 _v1, Vector3 _v2, Vector3 _n0, Vector3 _n1, Vector3 _n2, Vector2 _uv0, Vector2 _uv1, Vector2 _uv2, Color _col1, Color _col2, Color _col3, int _sg, int _mid)
	{
		v30 = _v0;
		v31 = _v1;
		v32 = _v2;
...
public class MegaCacheMeshConstructor
{
	...
	static public List<Color>				cols	= new List<Color>();
...
public class MegaCacheMeshConstructorOBJCol : MegaCacheMeshConstructor
{
	...
	static public void Construct(List<MegaCacheFace> faces, Mesh mesh, Vector3[] meshverts, bool optimize, bool recalc, bool tangents)
	{
		...
		{
			int mtlid = faces[i].mtlid;
			int v0 = FindVertGrid(faces[i].v30, faces[i].n0, faces[i].uv0, faces[i].col1);
			int v1 = FindVertGrid(faces[i].v31, faces[i].n1, faces[i].uv1, faces[i].col2);
			int v2 = FindVertGrid(faces[i].v32, faces[i].n2, faces[i].uv2, faces[i].col3);
...
public class MegaCacheMeshConstructorOBJNoUVCol : MegaCacheMeshConstructor
{
	static int FindVertGrid(Vector3 p, Vector3 n, Color col)
	{
		int sd = subdivs - 1;
	...
	static public void Construct(List<MegaCacheFace> faces, Mesh mesh, Vector3[] meshverts, bool optimize, bool recalc, bool tangents)
	{
		...
		{
			int mtlid = faces[i].mtlid;
			int v0 = FindVertGrid(faces[i].v30, faces[i].n0, faces[i].col1);
			int v1 = FindVertGrid(faces[i].v31, faces[i].n1, faces[i].col2);
			int v2 = FindVertGrid(faces[i].v32, faces[i].n2, faces[i].col3);
